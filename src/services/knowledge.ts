...
export class KnowledgeService extends Service implements IKnowledgeService {
  ...
  async get(_id: UUID): Promise<RAGKnowledgeItem | undefined> {
    return undefined
  ...
  async add(_id: UUID, _knowledge: RagKnowledgeItemContent): Promise<void> {
  ...
  async remove(_id: UUID): Promise<void> {
